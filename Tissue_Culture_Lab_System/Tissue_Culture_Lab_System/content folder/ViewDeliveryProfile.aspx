<%@ Page Title="" Language="C#" MasterPageFile="~/mainPage.Master" AutoEventWireup="true" CodeBehind="ViewDeliveryProfile.aspx.cs" Inherits="Tissue_Culture_Lab_System.content_folder.ViewDeliveryProfile" %>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <center>
                                        <p class="round3">Delivery Job Profile</p>
                                    </center>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="col">
                                        <div class="form-group">
                                        <center>
                                            <asp:Button class="btn btn-success btn-block btn-lg" ID="Button1" runat="server" Text="Update Delivery Job Profile" />
                                        </center>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="col">
                                        <div class="form-group">
                                        <center>
                                            <asp:Button class="btn btn-success btn-block btn-lg" ID="Button2" runat="server" Text="Generate Report" />
                                        </center>
                                        </div>
                                    </div>
                                </div
                                ...
                                <div class="col-md-4">
                                    <div class="col">
                                        <div class="form-group">
                                        <center>
                                            <asp:Button class="btn btn-success btn-block btn-lg" ID="Button3" runat="server" Text="Delete Delivery Job Profile" />
                                        </center>
                                        </div>
                                    </div>
                                </div>
