<%@ Page Title="" Language="C#" MasterPageFile="~/mainPage.Master" AutoEventWireup="true" CodeBehind="GH_DeletePlantDetails.aspx.cs" Inherits="Tissue_Culture_Lab_System.content_folder.GH_DeletePlantDetails" %>
               ...
               <div class="card-body">
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-6">
                        ...
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TextBox1" runat="server" placeholder=" Eg:- Mango " ReadOnly="true"></asp:TextBox>
                        </div>
                     </div> <br>
                     ...
                     <div class="col-md-6">
                        ...
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TextBox2" runat="server" placeholder="Enter the date here" TextMode="Date" ReadOnly="true"></asp:TextBox>
                        </div>
                     </div>
                  </div> <br>
                   ...
                   <div class="row">
                     <div class="col-md-6">
                        ...
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TextBox3" runat="server" placeholder="Ex:- Vilad" ReadOnly="true"></asp:TextBox>
                        </div>
                     </div> <br>
                     ...
                     <div class="col-md-6">
                        ...
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TextBox4" runat="server" placeholder="Enter a Value" TextMode="Number" ReadOnly="true"></asp:TextBox>
                        </div>
                     </div>
                   </div> <br>
                   ...
                   <div class="row">
                     <div class="col-md-6">
                        ...
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TextBox5" runat="server" placeholder="Ex:- Good " ReadOnly="true"></asp:TextBox>
                        </div> <br>
                     </div> 
                     ...
                     <div class="col-md-6">
                        ...
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TextBox6" runat="server" placeholder="Enter the date here" TextMode="Date" ReadOnly="true"></asp:TextBox>
                        </div> <br>
                     </div> 
                     ...
                     <div class="col-md-6">
                        ...
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TextBox8" runat="server" placeholder="Enter the Price in LKR          Ex:- 150.00 LKR" ReadOnly="true" ></asp:TextBox>
                        </div>
                     </div> 
                        </div> <br>
                     ...
                     <div class="col-md-6">
                        ...
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TextBox7" runat="server" placeholder="Ex:- Wet Zones(Colombo, Gampaha districts) " ReadOnly="true"></asp:TextBox>
                        </div> <br>
                     </div> 
                        ...
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TextBox10" runat="server" placeholder="Enter a number value in Days      Ex:- 45 Days " ReadOnly="true"></asp:TextBox>
                        </div> <br><br>
                     </div> 
                        ...
                        <asp:Button class="btn btn-danger btn-block btn-lg" ID="Button1" runat="server" Text="Delete All Details" OnClick="Button1_Click" />
