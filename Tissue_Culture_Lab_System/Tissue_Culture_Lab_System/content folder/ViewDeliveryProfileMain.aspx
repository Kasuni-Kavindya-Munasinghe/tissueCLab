...
<div class="page" style="background-color:lightgrey;">
    <div class="left" id="center" >   
        <ul id="Dp" box-sizing: border-box;>
                        ...
                        <li><a href="ViewDeliveryProfileMain.aspx" class ="b1"><center><i class='fas fa-file-export' style='font-size:30px;'><font id="font"><br />View job Profile Details </font></i></center></a></li>
                        <li><a href="AllJobProfiles.aspx" ><center><i class='fas fa-file-export' style='font-size:30px;'><font id="font"><br />View job Profiles </font></i></center></a></li>
        </ul>
    </div>
    <div class="right"  >
        <div class="container">
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <center>
                                        <p class="round3">View Delivery Job Profile</p>
                                    </center>
                                </div>
                            </div>
                            <div class="row">
                                <center>
                                <lable>Enter The Delivery Profile ID</lable>
                                <div class="form-group">
                                <asp:TextBox CssClass="form-control" id="TextBox1" runat="server" placeholder="Delivery Profile ID"></asp:TextBox>
                                </div>
                                </center>
                            </div>
                       <br />
                            <div class="row">
                                 <div class="col-md-4">
                                     <div class="col">
                                            <div class="form-group">
                                                <center>
                                                <asp:Button class="btn btn-success btn-block btn-lg" ID="Button1" runat="server" Text="Show Job Profile" OnClick="Button1_Click1"      />
                                 ...
                                 <div class="col-md-4">
                                      <div class="col">
                                            <div class="form-group">
                                                <center>
                                                <asp:Button class="btn btn-success btn-block btn-lg" ID="Button2" runat="server" Text="Update Job Profile" OnClick="Button2_Click"    />
                                                </center>
                                            </div>
                                       </div>
                                  </div>
                                 <div class="col-md-4">
                                       <div class="col">
                                            <div class="form-group">
                                            <center>
                                            <asp:Button class="btn btn-success btn-block btn-lg" ID="Button4" runat="server" Text="Delete Job Profile" OnClick="Button4_Click"    />
                                            </center>
                                            </div>
                                       </div>
                                 </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <asp:TextBox CssClass="form-control" id="TextBox7" runat="server" placeholder="Contact No" TextMode="Phone"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <label>CITY </label>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <asp:TextBox CssClass="form-control" id="TextBox9" runat="server" placeholder="E-Mail" TextMode="Email"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <label>Country</label>
                ...
                <!-- Plant Detail Section -->
                            ...
                            <div class="row">
                                <div class="col">
                                    <center>
                                        <h2 align="left">Plant Details </h2>
                                    </center>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <asp:TextBox CssClass="form-control" id="TextBox10" runat="server" placeholder="Name"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <asp:TextBox CssClass="form-control" id="TextBox12" runat="server" placeholder="Handled Week"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <label>Number Of Plants(Varitey Based)</label>
                                    <div class="form-group">
                                        <asp:TextBox CssClass="form-control" id="TextBox13" runat="server" placeholder="Number Of Variteys"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <label>Number Of Plant Tubs</label>
                                    <div class="form-group">
                                        <asp:TextBox CssClass="form-control" id="TextBox14" runat="server" placeholder="Number Of Tubs"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col">
                            ...
                            <div class="row">
                                    <div class="col">
                                        ...
                                        <div class="form-group">
                                            <asp:TextBox CssClass="form-control" id="TextBox38" runat="server" placeholder="Names" TextMode="MultiLine"></asp:TextBox>
                                    </div>
                            </div>
                           <div class="row">
                               <div class="col-md-6">
                ...
                <!-- Delivery Details Section -->
                        ...
                        <div class="row">
                         ...
                         <!-- packing plan buttons -->
                              <div class="row">
                                 <div class="col-md-4">
                                     <div class="col">
                                            <div class="form-group">
                                                <center>
                                                <asp:Button class="btn btn-success btn-block btn-lg" ID="Button3" runat="server" Text="Show packing Plan" OnClick="Button3_Click" />
                                 ...
                                 <div class="col-md-4">
                                      <div class="col">
                                            <div class="form-group">
                                                <center>
                                                <asp:Button class="btn btn-success btn-block btn-lg" ID="Button5" runat="server" Text="Update Packing Plan" OnClick="Button5_Click" />
                                                </center>
                                            </div>
                                       </div>
                                  </div>
                                ...
                                <div class="col-md-3">
                                       <div class="col">
                                            <div class="form-group">
                                            <center>
                                            <asp:Button class="btn btn-success btn-block btn-lg" ID="Button6" runat="server" Text="Delete Packing plan" OnClick="Button6_Click" />
                                            </center>
                                            </div>
                                       </div>
                                 </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <label>Number Of Packed Plants</label>
                                                        <div class="form-group">
                                                            <asp:TextBox CssClass="form-control" id="TextBox4" runat="server" placeholder="No Of Plants" TextMode="Number"></asp:TextBox>
                                                        </div>
                                                </div>
